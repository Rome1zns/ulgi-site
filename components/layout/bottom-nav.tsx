...
import { Home, Bell, Plus, Bot, Shield } from "lucide-react";
import { kk } from "@/lib/locale/kk";

const items = [
  { href: "/feed", icon: Home, label: kk.nav.feed },
  { href: "/announcements", icon: Bell, label: "Хабар" },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 flex h-16 items-center justify-around border-t-2 border-[var(--duo-border)] bg-white md:hidden">
